...
def plot_phase2():
    ...
    plt.title("Phase 2: Mean Order Quantity vs Loss Aversion (lambda)", fontsize=16)
    plt.ylabel("Mean Order Quantity")
    plt.xlabel("Loss Aversion Intensity (lambda) for Averse Agents")
    ...
    plt.title("Phase 2: Network Inventory vs Loss Aversion (lambda)", fontsize=16)
    ...
    plt.title("Phase 2: Economic Profit vs Loss Aversion (lambda)", fontsize=16)
    ...
    plt.title("Phase 2: Lost Sales vs Loss Aversion (lambda)", fontsize=16)
