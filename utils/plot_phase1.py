...
def plot_phase1():
    ...
    plt.title("Phase 1: Supply Chain Bullwhip vs Loss Aversion (phi)", fontsize=16)
    plt.ylabel("Bullwhip Ratio (Var(Orders) / Var(Demand))")
    plt.xlabel("Fraction of Loss-Averse Agents (phi)")
    ...
    plt.title("Phase 1: Economic Profit vs Loss Aversion (phi)", fontsize=16)
    ...
    plt.title("Phase 1: Mean Order Quantity vs Loss Aversion (phi)", fontsize=16)
