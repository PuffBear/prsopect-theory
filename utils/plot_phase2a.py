...
def plot_phase2a():
    ...
    plt.title("Phase 2A: PPO Mean Order vs Loss Aversion (lambda)", fontsize=16)
    ...
    plt.title("Phase 2A: Network Inventory vs Loss Aversion (lambda)", fontsize=16)
    ...
    plt.title("Phase 2A: Economic Profit vs Loss Aversion (lambda)", fontsize=16)
    ...
    plt.title("Phase 2A: Lost Sales vs Loss Aversion (lambda)", fontsize=16)
